...
# 1 "losescreen.h" 1
# 22 "losescreen.h"
extern const unsigned short losescreenTiles[9360];
...
void goToGame() {
    ...
    DMANow(3, galaxyPal, ((unsigned short *)0x5000000), 256);



    (*(volatile unsigned short*)0x4000008) = (0<<14) | ((0)<<2) | ((31)<<8);

    DMANow(3, galaxyTiles, &((charblock *)0x6000000)[0], 17984/2);
    DMANow(3, galaxyMap, &((screenblock *)0x6000000)[31], 2048/2);
...
void goToPause() {
    ...
    DMANow(3, pausescreenTiles, &((charblock *)0x6000000)[0], 18208/2);
...
void goToWin() {
    ...
    DMANow(3, winscreenTiles, &((charblock *)0x6000000)[0], 36864/2);
...
void goToLose() {
    ...
    DMANow(3, losescreenTiles, &((charblock *)0x6000000)[0], 18720/2);
